...
{
    /// <summary>
    /// Summary description for StatesChange
    /// </summary>
    public class StatesChange : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            var jsonObject = new { cities = citiesHtml, message = String.Empty, success = true, markers };
